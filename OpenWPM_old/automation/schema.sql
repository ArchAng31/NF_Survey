...
/* Extracted Static Resource Loads table */
CREATE TABLE IF NOT EXISTS Resource_Loads_Static (
    crawl_url TEXT,
    resource_url TEXT,
    window_url TEXT,
    content_type TEXT,
...
/* Extracted Dynamic Resource Loads table */
CREATE TABLE IF NOT EXISTS Resource_Loads_Dynamic (
    crawl_url TEXT,
    resource_url TEXT,
    window_url TEXT,
    content_type TEXT,
